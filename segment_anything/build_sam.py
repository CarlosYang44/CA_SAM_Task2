...
from .modeling import ImageEncoderViT, MaskDecoder, PromptEncoder, Sam, TwoWayTransformer, ImageEncoderViTMoDA
...
def build_sam_vit_h(args):
    return _build_sam(
        ...
        use_moda_encoder=getattr(args, "use_moda_encoder", False),
    )
...
def _build_sam(
    ...
    EncoderClass = ImageEncoderViTMoDA if use_moda_encoder else ImageEncoderViT
    sam = Sam(
        image_encoder=EncoderClass(
            depth=encoder_depth,
